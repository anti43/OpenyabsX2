...
<html>
    ...
    <body>
        <a href="#edit-receiptType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-receiptType" class="content scaffold-edit" role="main">
            <h1><g:message code="default.edit.label" args="[entityName]" /></h1>
            <g:if test="${flash.message}">
            <div class="alert alert-info" role="status">${flash.message}</div>
            </g:if>
            <g:hasErrors bean="${this.receiptType}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.receiptType}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.receiptType}" method="PUT">
                <g:hiddenField name="version" value="${this.receiptType?.version}" />
                <fieldset class="form">
                    <f:all bean="receiptType"/>
                </fieldset>
